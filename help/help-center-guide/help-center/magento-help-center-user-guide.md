...
>[!NOTE]
>
>Adobe Commerce support has migrated from Adobe Commerce Help Center to Experience League. Use the Experience League case form flow described [here](#what-is-experience-support) to submit support cases.<br>At this time, to view to your previously-submitted cases on Adobe Commerce Help Center, you will have to go to https://support.magento.com/hc/en-us/requests as these cases have not been migrated to this new system. The Help Center is now read-only; to continue receiving support for the original issue, you will have to submit a follow-up ticket to Experience League Support](https://experienceleague.adobe.com/home#support). 
