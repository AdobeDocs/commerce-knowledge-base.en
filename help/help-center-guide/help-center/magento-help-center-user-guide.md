...
>1. If you don't see Adobe Commerce in the [!UICONTROL Select a product] dropdown when submitting a Commerce-related case, you must first obtain [Shared Access](#shared-access) from the Commerce Account Owner.
