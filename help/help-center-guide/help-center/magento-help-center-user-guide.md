...
>[!NOTE] The user in CC: must have an existing account at https://account.magento.com - if not, they must first create one at https://account.adobe.com and login to https://account.magento.com with that account.
