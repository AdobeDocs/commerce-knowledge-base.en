...
To restore an existing snapshot (on the supported environment, i.e., Integration, Staging, Production on Starter plan; OR Integration on Pro plan,) follow the steps in [Snapshots and backup management: Restore a snapshot](https://devdocs.magento.com/cloud/project/project-webint-snap.html#restore-snapshot) in our developer documentation.
