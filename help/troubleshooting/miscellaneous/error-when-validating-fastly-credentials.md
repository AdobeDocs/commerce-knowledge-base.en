...
1. If the command doesn't return the error, make sure that you are running the newest version of the Fastly extension. If you are on an older version prior to 1.2.203, you must first click on `Save Config` before you can test the credentials.
