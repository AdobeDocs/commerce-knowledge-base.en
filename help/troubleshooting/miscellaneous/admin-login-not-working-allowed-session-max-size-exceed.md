...
// you can also set to higher than 500000 depending on the existing max size reported in the error and you can set the value to 0 to remove the session size limit))
```
