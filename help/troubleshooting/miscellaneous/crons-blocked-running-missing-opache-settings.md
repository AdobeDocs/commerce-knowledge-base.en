...
1. If the cron is currently disabled, run this command to re-enable the cron: `vendor/bin/ece-tools cron:enable`
...
1. If you are already on the latest version of ECE Tools, check for the presence of the `op-exclude.txt` file:
`ls op-exclude.txt`
