---
description: This article talks about a suggested solution to when a javascript Webpack hangs for a long time before beginning compilation in Progressive Web App Studio (PWA Studio).
