...
To get a list of ongoing activities run the following command using magento-cloud CLI (if you have only been added to one cloud project). Check you are on the latest version of magento-cloud CLI. For steps, refer to [Update the CLI](/docs/commerce-cloud-service/user-guide/dev-tools/cloud-cli/cloud-cli-overview#update-the-cli) in the Commerce on Cloud Infrastructure guide. 
