---
description: This article provides a patch for the Magento Commerce issue when a customer gets a 404 error when they attempt to access Advanced Reporting. After this patch is installed, users will be able to access Advanced Reporting.
