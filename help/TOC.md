...
* Support Tools {#support-tools}
  ...
  * Patches available in QPT tool {#patches}
    ...
    * v1.1.32 {#v1-1-32}
        ...
        * [ACSD-51294: Price, quantity, tax, shipping, and revenue are sent as string to [!DNL Google Analytics] and GTM](/help/support-tools/patches-available-in-qpt-tool/v1-1-32/acsd-51294-price-quantity-tax-shipping-and-revenue-are-sent-as-string-to-google-analytics-and-gtm.md)
