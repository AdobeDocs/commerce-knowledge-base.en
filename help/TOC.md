...
* Support Tools {#support-tools}
  ...
  * Patches available in QPT tool {#patches}
    ...
    * [ACSD-48313: **[!UICONTROL configurable_variations]** column not parsed if attribute value contains comma](/help/support-tools/patches-available-in-qpt-tool/acsd-48313-configurable_variations-column-not-parsed-attribute-value-contains-comma.md)
