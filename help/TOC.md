...
* Support Tools {#support-tools}
  ...
  * Patches available in QPT tool {#patches}
    ...
    * v1.1.43 {#v1-1-43}
        ...
        * [ACSD-53636: Regular price is not displayed on product listing page](/help/support-tools/patches-available-in-qpt-tool/v1-1-43/acsd-53636-regular-price-is-not-displayed-on-product-listing-page.md)
