...
* Support Tools {#support-tools}
  ...
  * Patches available in QPT tool {#patches}
    ...
    * v1.1.29 {#v1-1-29}
        ...
        * [ACSD-49773: Product export fails when [!DNL AWS S3] is used as remote storage](/help/support-tools/patches-available-in-qpt-tool/v1-1-29/acsd-49773-product-export-fails-when-aws-s3-is-used-as-remote-storage.md)
