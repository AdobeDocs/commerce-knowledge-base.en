...
* Support Tools {#support-tools}
  ...
  * Patches available in QPT tool {#patches}
    ...
    * v1.1.43 {#v1-1-43}
        ...
        * [ACSD-54739: [!UICONTROL Product Stock] status not applied for related [!UICONTROL Product rules]](/help/support-tools/patches-available-in-qpt-tool/v1-1-43/acsd-54739-product-stock-status-not-applied-for-related-product-rules.md)
