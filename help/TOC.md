...
* Support Tools {#support-tools}
  ...
  * Patches available in QPT tool {#patches}
    ...
    * v1.1.49 {#v1-1-49}
        ...
        * [ACSD-58163: Price rule does not apply a discount without coupon code](/help/support-tools/patches-available-in-qpt-tool/v1-1-49/acsd-58163-price-rule-does-not-apply-a-discount-without-coupon-code.md)
    * v1.1.50 {#v1-1-50}
