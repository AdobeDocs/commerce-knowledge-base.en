...
* Support Tools {#support-tools}
  ...
  * Patches available in QPT tool {#patches}
    ...
    * V1.1.27 {#v1-1-27}
        ...
        * [ACSD-47908: fixes the error where a value less than or equal to 0 is expected during checkout](/help/support-tools/patches-available-in-qpt-tool/v1-1-27/acsd-47908-fixes-the-error-a-value-less-than-or-equal-to-0-is-expected-during-checkout.md)
