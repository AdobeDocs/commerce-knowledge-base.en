...
* Support Tools {#support-tools}
  ...
  * Patches available in QPT tool {#patches}
    ...
    * v1.1.40 {#v1-1-40}
        ...
        * [ASCD-54040: [!UICONTROL Created] field is blank in order details page when B2B modules are enabled](/help/support-tools/patches-available-in-qpt-tool/v1-1-40/acsd-54040-created-field-is-blank-in-order-details-page.md)
