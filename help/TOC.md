...
* Support Tools {#support-tools}
  ...
  * Patches available in QPT tool {#patches}
    ...
    * v1.1.50 {#v1-1-50}
        ...
        * [ACS-59036: Exception happens when loading product prices](/help/support-tools/patches-available-in-qpt-tool/v1-1-50/acsd-59036-exception-happens-when-loading-product-prices.md)
