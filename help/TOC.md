...
* Troubleshooting {#troubleshooting}
  ...
  * Known issues {#known-issues-patches-attached}
    ...
    * [[!UICONTROL salesRule] labels upgrade from versions < 2.4.5](/help/troubleshooting/known-issues-patches-attached/salesrules-label-issues-when-upgrade-from-versions-under-2.4.5.md)
