...
* Support Tools {#support-tools}
  ...
  * Patches available in QPT tool {#patches}
    ...
    * v1.1.48 {#v1-1-48}
        ...
        * [ACSD-57315: New transaction created in [!DNL PayPal Payflow Pro] each time the fetch button is clicked](/help/support-tools/patches-available-in-qpt-tool/v1-1-48/acsd-57315-new-transaction-created-in-PayPal-Payflow-Pro-each-time-the-fetch-button-is-clicked.md)   
