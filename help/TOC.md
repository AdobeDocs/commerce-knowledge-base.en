...
* Support Tools {#support-tools}
  ...
  * Patches available in QPT tool {#patches}
    ...
    * v1.1.50 {#v1-1-50}
        ...
        * [ACSD-59280: Fix for `ReflectionUnionType::getName()` error in 2.4.4-pX installations](/help/support-tools/patches-available-in-qpt-tool/v1-1-50/acsd-59280-fix-for-reflection-union-type-error.md)
