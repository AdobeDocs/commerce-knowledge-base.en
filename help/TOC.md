...
* Support Tools {#support-tools}
  ...
  * Patches available in QPT tool {#patches}
    ...
    * V1.1.28 {#v1-1-28}
        ...
        * [ACSD-48204: Catalog price rule created based on *Yes/No* attribute don't consider selected scope](/help/support-tools/patches-available-in-qpt-tool/v1-1-28/acsd-48204-catalog-price-rule-created-based-on-yes-no-attribute-does-not-consider-the-selected-scope.md)
