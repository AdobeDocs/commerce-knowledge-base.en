...
* Support Tools {#support-tools}
  ...
  * Patches available in QPT tool {#patches}
    ...
    * v1.1.33 {#v1-1-33}
        ...
        * [ACSD-51907: Restricted admin user can't create a credit memo with an offline refund](/help/support-tools/patches-available-in-qpt-tool/v1-1-33/acsd-51907-restricted-admin-user-cannot-create-a-credit-memo-with-an-offline-refund.md)
