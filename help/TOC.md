...
* Support Tools {#support-tools}
  ...
  * Patches available in QPT tool {#patches}
    ...
    * v1.1.49 {#v1-1-49}
        ...
        * [ACSD-58375: Wrong YouTube API Key configuration causes an error when adding a YouTube video at the store view level](/help/support-tools/patches-available-in-qpt-tool/v1-1-49/acsd-58375-wrong-youtube-api-key-configuration-causes-an-error-when-adding-a-youtube-video-at-the-store-view-level.md)
    * v1.1.50 {#v1-1-50}
