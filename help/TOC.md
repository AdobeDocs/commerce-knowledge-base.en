...
* Support Tools {#support-tools}
  ...
  * Patches available in QPT tool {#patches}
    ...
    * v1.1.47 {#v1-1-47}
        ...
        * [ACSD-56760: Admin user is restricted to a specific website and cannot sort or add new products](/help/support-tools/patches-available-in-qpt-tool/v1-1-47/admin-user-is-restricted-to-a-specific-website-and-cannot-sort-or-add-new-products.md)
    * v1.1.48 {#v1-1-48}
