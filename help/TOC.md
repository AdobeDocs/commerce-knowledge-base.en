...
* Support Tools {#support-tools}
  ...
  * Patches available in QPT tool {#patches}
    ...
    * v1.1.44 {#v1-1-44}
        ...
        * [ACSD-56193: [!DNL Fastly/Varnish] cache not cleared for content staging](/help/support-tools/patches-available-in-qpt-tool/v1-1-44/acsd-56193-fastly-cache-not-cleared-for-content-staging-update.md)
