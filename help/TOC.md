...
* Troubleshooting {#troubleshooting}
  ...
  * Known issues {#known-issues-patches-attached}
    ...
    * [Adobe Commerce 2.4.6 error placing order from Admin panel](/help/troubleshooting/known-issues-patches-attached/adobe-commerce-2.4.6-known-issue-patch-error-when-placing-an-order-from-the-admin-panel.md)
