...
* Support Tools {#support-tools}
  ...
  * Patches available in QPT tool {#patches}
    ...
    * v1.1.48 {#v1-1-48}
        ...
        * [ACSD-55566: [!UICONTROL mergeCart mutation] fails with an `Internal Server Error` in [!UICONTROL GraphQL] response](/help/support-tools/patches-available-in-qpt-tool/v1-1-48/acsd-55566-mergecart-mutation-fails-with-an-internal-server-error-in-graphql-response.md)   
