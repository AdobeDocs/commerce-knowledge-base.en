...
* Support Tools {#support-tools}
  ...
  * Patches available in QPT tool {#patches}
    ...
    * V1.1.24 {#v1-1-24}
        ...
        * [ACSD-47920: a guest user can place orders via REST API even when [!UICONTROL Allow Guest Checkout] is off](/help/support-tools/patches-available-in-qpt-tool/v1-1-24/acsd-47920-guest-order-allow-guest-checkout-off.md)
    ...
    * V1.1.28 {#v1-1-28}
        ...
        * [ACSD-49179: orders report shows incorrect amounts in case of different currencies for different stores](/help/support-tools/patches-available-in-qpt-tool/v1-1-28/acsd-49179-orders-report-shows-incorrect-amounts-in-case-of-different-currencies-for-different-stores)
