  ...
  * Patches available in QPT tool {#patches}
    ...
    * v1.1.45 {#v1-1-45}
        ...
        * [ACSD-52824: Disabled payment methods displayed for company customers](/help/support-tools/patches-available-in-qpt-tool/v1-1-45/acsd-52824-payment-method-display-dicrepancy.md)
        [ASCD-56415: Perfomance of the partial price indexing is slowed down due to a DELETE query](/help/support-tools/patches-available-in-qpt-tool/v1-1-45/acsd-56415-performance-of-partial-price-indexing-is-slowed-down-due-to-a-delete-query.md)
    * v1.1.46 {#v1-1-46}
