...
* Support Tools {#support-tools}
  ...
  * Patches available in QPT tool {#patches}
    ...
    * v1.1.33 {#v1-1-33}
        ...
        * [ACSD-51645: Saving a new Cart Price Rule if the extension Magento_OfflineShipping is disabled](/help/support-tools/patches-available-in-qpt-tool/v1-1-33/acsd-51645-saving-a-new-cart-price-pule-if-the-extension-magento-offlineshipping-is-disabled.md)
