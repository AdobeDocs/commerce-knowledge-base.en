...
* Support Tools {#support-tools}
  ...
  * Patches available in QPT tool {#patches}
    ...
    * v1.1.50 {#v1-1-50}
        ...
        * [ACSD-58352: Return attribute labels for the default store are returned via GrapghQL API](/help/support-tools/patches-available-in-qpt-tool/v1-1-50/acsd-58352-return-attribute-labels-for-the-default-store-are-returned-via-grapghql-api.md)
