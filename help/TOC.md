...
* Support Tools {#support-tools}
  ...
  * Patches available in QPT tool {#patches}
    ...
    * v1.1.50 {#v1-1-50}
        ...
        * [ACSD-45049: Customer attribute [!UICONTROL Is required] setting doesn't work as per website scope in Admin](/help/support-tools/patches-available-in-qpt-tool/v1-1-50/acsd-45049-customer-attribute-is-required-setting-doesnt-work.md)
