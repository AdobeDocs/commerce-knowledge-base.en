...
* Support Tools {#support-tools}
  ...
  * Patches available in QPT tool {#patches}
    ...
    * v1.1.50 {#v1-1-50}
        ...
        * [ACSD-58790: Fixes pinch to zoom functionality on the product detail page images in mobile view on Chrome](/help/support-tools/patches-available-in-qpt-tool/v1-1-50/acsd-58790-fixes-pinch-to-zoom-functionality-on-the-product-detail-page-images-in-mobile-view-on-chrome.md)
