...
* Troubleshooting {#troubleshooting}
  ...
  * Miscellaneous {#miscellaneous}
    ...
    * [The `Magento-cloud` [!DNL CLI] doesn't show an active environment](/help/troubleshooting/miscellaneous/the-magento-cloud-cli-doesnt-show-an-active-environment.md)
