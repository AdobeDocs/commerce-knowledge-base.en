...
* Support Tools {#support-tools}
  ...
  * Patches available in QPT tool {#patches}
    ...
    *  [ACSD-47559: preview [!UICONTROL Preview Template] not fully visible](/help/support-tools/patches-available-in-qpt-tool/acsd-47559-venmo-videos-cannot-be-played-on-the-storefront.md)
    * [ACSD-47920: Fixes the issue where orders can be placed via Rest API as a guest user even when the "Allow Guest Checkout" is turned off](/help/support-tools/patches-available-in-qpt-tool/acsd-47920-guest-order-allow-guest-checkout-off.md)
