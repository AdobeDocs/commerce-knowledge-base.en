...
description: Apply the ACSD-56023 patch to fix the Adobe Commerce issue where the Widget content is not updated on the CMS page.
feature: CMS
...
1. Create new CMS page and add new products widget to the content:
