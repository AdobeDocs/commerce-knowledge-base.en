---
title: 'ACSD-50895: Fixes the issue where Google Analytics 3 GTM tags are not fired if Google Analytics 4 GTM is not configured'
description: Apply the ACSD-50895 patch to fix the Adobe Commerce issue where Google Analytics 3 GTM tags are not fired if Google Analytics 4 GTM is not configured.
---
# ACSD-50895: Fixes the issue where Google Analytics 3 GTM tags are not fired if Google Analytics 4 GTM is not configured.
...
Fixes the issue where Google Analytics 3 GTM tags are not fired if Google Analytics 4 GTM is not configured.
