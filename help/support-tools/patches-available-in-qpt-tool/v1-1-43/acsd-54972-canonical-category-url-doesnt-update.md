...
3. Update the *[!UICONTROL URL Key]* to something different from the original value while keeping the **[!UICONTROL Create Permanent Redirect for old URL]** checkbox ticked.
4. Clean the cache.
