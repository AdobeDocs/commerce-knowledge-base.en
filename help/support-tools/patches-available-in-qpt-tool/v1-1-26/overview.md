...
1. **ACSD-47937** (for Adobe Commerce and Magento Open Source 2.4.4 || >=2.4.5 <2.4.6) - Fixes the issue where price drop notifications are not always sent due to application-level caching.
