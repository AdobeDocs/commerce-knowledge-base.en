---
title: 'ACSD-58163: [!UICONTROL Price Rule] does not apply a discount without coupon code'
...
# ACSD-58163: [!UICONTROL Price Rule] doesn't apply a discount without coupon code
