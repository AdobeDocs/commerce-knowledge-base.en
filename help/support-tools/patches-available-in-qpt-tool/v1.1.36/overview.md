...
1. **ACSD-50887**: Fixes the issue where the product attribute property *[!UICONTROL Use in Search Results Layered Navigation]* can be set to Yes without the Use in search option set to Yes.
...
1. **ACSD-53176**: Fixes the issue where *[!UICONTROL Related Product Rule]* with *is one of* condition does not match products.
